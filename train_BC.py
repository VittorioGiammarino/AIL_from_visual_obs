...
class Workspace:
    ...
    def train(self):
        # predicates
        train_until_step = utils.Until(self.cfg.num_train_steps, self.cfg.action_repeat)
        eval_every_step = utils.Every(self.cfg.eval_every_steps, self.cfg.action_repeat)
        ...
        while train_until_step(self.global_step):
            ...
            metrics = self.agent.update(self.replay_buffer_expert)
...
@hydra.main(config_path='config_folder/POMDP', config_name='config_bc')
def main(cfg):
